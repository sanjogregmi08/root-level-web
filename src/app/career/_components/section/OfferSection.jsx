...
// const OfferSection = () => {
//   return (
//     <div className="mx-16 py-12 px-4">
//         <div className="md:w-1/3 ml-14 mb-8 md:mb-0">
...
//           <div className="flex gap-20 pl-20 flex-col md:flex-row items-center mb-12">
//             <div className="mb-6 md:mb-0 md:mr-8">
//               <Image
//                 src="/career_image_1.png"
//                 width={1500}
...
//           <div className="flex gap-20 flex-col pl-20 md:flex-row-reverse items-center mb-12">
//             <div className="mb-6 md:mb-0 md:ml-8">
//               <Image
//                 src="/career_image_2.png"
//                 width={1000}
...
//           <div className="flex gap-20 flex-col pl-20 md:flex-row items-center">
//             <div className="mb-6 md:mb-0 md:mr-8">
//               <Image
//                 src="/career_image_3.png"
//                 width={500}
